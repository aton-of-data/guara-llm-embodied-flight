...
| AC-63 | K | M19 | in progress | spec_s3 T1–T9; adr0010 rules 1–3; monitor_table H-4/H-6 including 17th-id overflow, driven by C ABI ctest; geofence predictor hosted in `core/` with C ABI (AC-8 case); published geofence vectors and rules 6–7 PARAMETER TBD |
