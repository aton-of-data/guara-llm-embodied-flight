...
| AC-57 | K | M18 | in progress | `core/` CMake library and C ABI; `guara params check`; coding subset [REVIEW]; digest logged at arbiter start; ROS does not yet publish it on RtaState |
